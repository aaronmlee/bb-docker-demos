...
docker run -i --rm --name $MONITOR -v $DEMOLOGS/$MONITOR:/var/log -link consul-agent-local-join:CONSUL_LOCAL -p 8300:8300 -p 8301:8301 -p 8302:8302 -p 8400:8400 -p 8500:8500 -p 8600:8600 $MONITOR 
